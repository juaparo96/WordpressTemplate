  ...
  <div class="sunset-sidebar">
    ...
    <div class="icons-wrapper">
        <?php if (!empty( $twitter_icon ) ):  ?>
          <span class="sunset-icon-sidebar dash-before dashicons-twitter"></span>
        <?php endif; ?>
        <?php if (!empty( $gplus_icon ) ): ?>
          <span class="sunset-icon-sidebar sunset-icon-sidebar--gplus dash-before dashicons-googleplus"></span>
        <?php endif; ?>
        <?php if (!empty( $facebook_icon ) ):  ?>
          <span class="sunset-icon-sidebar dash-before dashicons-facebook-alt"></span>
        <?php endif; ?>
    </div>
  </div>
</div>
