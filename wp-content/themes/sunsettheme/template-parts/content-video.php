...
<article id="post-<?php  the_ID(); ?>" <?php post_class('sunset-format-video'); ?> >
  ...
  <header class="entry-header text-center">
    ...
    <div class="embed-responsive embed-responsive-16by9"><?php echo sunset_get_embedded_media(array('video', 'iframe'));?></div>
  ...
  <div class="entry-content">
    ...
    <?php if ( sunset_get_attachment() ) : ?>
      ...
      <a class="standart-featured-link"  href="<?php the_permalink(); ?>">
